...
<script src="\pupwebdev-student\assets\javascript\jquery-3.3.1.min.js" type='text/javascript'>
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/pupwebdev-student/auth/footer.php' ?>
		...
		<!-- ANNOUNCEMENT HERE! -->
          <marquee class="GeneratedMarquee" direction="left" scrollamount="8" behavior="scroll">
			<?php
				// include_once '/PUP/pupwebdev/auth/dbConnect.php';
...
<script>
  ...
  soundHandle.src = '/pupwebdev-student/auth/admin/sound/dingdong.mp3';
</script>