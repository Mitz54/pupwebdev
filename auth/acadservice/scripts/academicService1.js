$(document).ready(function() 
{
  ...
  $('#Room').change (function() 
  {
    ...
    room_=strUser;
    $('#room_calendarview').fullCalendar( 'removeEventSource', url ="./acadService_loadEvent.php?room=" + holdroom)
    $('#room_calendarview').fullCalendar( 'addEventSource', url ="./acadService_loadEvent.php?room=" + room_)
    holdroom=room_;
  });
  ...
  ({
    ...
    allDaySlot: false,
    events: url ="./acadService_loadEvent.php?room=" + room_,
    eventOverlap: false,
    eventColor: '#8f0400',
