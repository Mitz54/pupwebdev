...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <form action = "PendNumber.php" method = "post">
      <input class="btn btn-info pend" type="submit" id="pendBut" name ="pendbt" value = "Pend" style="margin: -50px 0px 0px 720px;"/>
      <div class="col-sm-4">
      <input class="textbox-selected" style="position: absolute; margin: -55px 0px 0px 800px;" type="text" name="pendRemark" id="pendRemark" placeholder="Pend" autocomplete="off"required/>
      </form>
      <br>
