...
class PDF extends FPDF {
	function Header(){
		...
		$this->Cell(0,5,'SPECIFIC ITEM LIST',0,1,'C');
	...
	function create()
	{
		...
		$this->Cell(55,5,'',0,1);
		$this->Cell(10,10,'',0,0);
		$this->Cell(15.8,5,"Item ID",1,0);
		$this->Cell(53.8,5,"Item Name",1,0,'C');
		$this->Cell(34.8,5,"Serial Number",1,0,'C');
		$this->Cell(34.8,5,"Condition",1,0,'C');
		$this->Cell(34.8,5,"Borrowable",1,0,'C');
...
while($row = $stmt->fetch())
{
	...
	$i = $i + 1;
		...
		$pdf->Cell(10,10,'',0,0);
		$pdf->Cell(15.8,5,$row['itemID'],1,0);
		$pdf->Cell(53.8,5,$row['name'],1,0,'C');
		$pdf->Cell(34.8,5,$row['serialNumber'],1,0,'C');
		$pdf->Cell(34.8,5,$row['condition'],1,0,'C');
		$pdf->Cell(34.8,5,$borrowable,1,1,'C');
	if($i == 24)
	{
		$pdf->AddPage(); //for another page
		$pdf->create();
