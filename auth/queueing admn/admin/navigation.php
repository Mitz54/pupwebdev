...
<nav class="navbar navbar-light">
  ...
  <?php
    ...
    $pageOn = explode('/pupwebdev-kiosk/auth/admin/', $path);
  ...
  <div class="dashboard-menu">
    <ul class="nav nav-pills flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if($activenav=='account.php') {echo 'active';} ?>" href="professor.php"><i class="fas fa-chalkboard-teacher icon"></i>Account</a>
      </li>
      <li class="nav-item">
