<?php session_start(); ?>
<?php 
	 include $_SERVER['DOCUMENT_ROOT'] . '/pupwebdev-kiosk/auth/header.php';
      include 'php\db.php';
      $selected = 0;
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/pupwebdev-kiosk/auth/footertrans.php' ?>

<script src="/pupwebdev-kiosk/auth/admin/scripts/Transaction.js" type="text/javascript"></script>
